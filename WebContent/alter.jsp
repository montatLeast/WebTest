    ...
    %>
		<div class="leftside">
			...
			<div class="teachersummary">
				...
				<input type="submit" name="submitphoto" value="提交">
				</form>
				</div>
				<div class="name">
				...
				<div class="baseinfo">
				<form action="LoginServlet?method=alter" method="post">
				<table style="margin-left:20px;">
				<tbody>
					<tr><td>性别：</td><td><input type="text" name="sex" value="<%out.println(pinfo.getSex()); %>"></td></tr>
					<tr><td>学校：</td><td><input type="text" name="school" value="<%out.println(pinfo.getSchool()); %>"></td></tr>
					<tr><td>学院：</td><td><input type="text" name="major" value="<%out.println(pinfo.getMajor()); %>"></td></tr>
					<tr><td>班级：</td><td><input type="text" name="className" value="<%out.println(pinfo.getClassName()); %>"></td></tr>
				</tbody>
				</table>
					<input type="submit" name="submitalter" value="提交">
				</form>
				</div>
			</div>
